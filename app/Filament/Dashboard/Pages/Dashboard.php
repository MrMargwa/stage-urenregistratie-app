...
class Dashboard extends \Filament\Pages\Dashboard implements HasTable
{
    ...
    public function getWeekSummaryProperty(): string
    {
        ...
        return $loggedDays === 1
            ? 'Je hebt op 1 dag uren bijgehouden deze week.'
            : "Je hebt op {$loggedDays} dagen uren bijgehouden deze week.";
    }
    ...
    public function getWeekLabelProperty(): string
    {
        ...
        return $start->translatedFormat('d M').' – '.$end->translatedFormat('d M Y').' · week '.$start->isoWeek();
    }
