    ...
    public function form(Schema $schema): Schema
    {
        return $schema
            ...
            ->components([
                Section::make('Account')
                    ...
                    ->schema([
                        ...
                        TextInput::make('password')
                            ...
                            ->rule('min:8')
                            ->nullable()
                            ->hintIcon('heroicon-m-information-circle', tooltip: 'Laat dit leeg om je huidige wachtwoord te behouden. Minimaal 8 tekens.')
                            ->validationMessages([
                ...
                Section::make('Stage')
                    ->description('Stel hier het totale aantal uren in dat je moet lopen.')
                ...
                Section::make('Standaard werktijden')
                    ...
                    ->schema([
                        ...
                        TimePicker::make('default_end_time')
                            ...
                            ->validationMessages([
                                'after_or_equal' => 'De eindtijd kan niet vóór de begintijd liggen.',
                            ]),
