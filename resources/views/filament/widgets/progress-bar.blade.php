...
@else
    <div style="background:var(--fi-bg);border:1px solid var(--fi-border);border-radius:12px;padding:16px 20px;">
        ...
        <p style="margin:4px 0 0;font-size:13px;color:var(--fi-text-muted);">
            Stel je totale stage-uren in via je <a href="{{ route('filament.dashboard.pages.settings') }}" style="color:var(--fi-primary-500);text-decoration:underline;">instellingen</a>.
        </p>
    </div>
@endif
